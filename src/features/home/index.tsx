...
import AreYouReady from "../auth/components/are-you-ready";
          ...
          <div className="flex flex-col gap-6 mt-48">
            ...
            >
              ...
              <p className="text-xl text-primary-600 mb-12">
                ...
                into a complete, structured entry with relevant details, tags,
                and sources. No effort required. AI-enhanced notes that adapt to
                you.
              </p>
            </motion.div>
